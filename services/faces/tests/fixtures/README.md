...
The tests check one/multiple faces, resized copies, normalized vectors, invalid
inputs, and recovery of recognition detail from an original-resolution crop when
the same face is tiny in the detection preview. This is a functional smoke test,
**not** an accuracy benchmark across ages,
