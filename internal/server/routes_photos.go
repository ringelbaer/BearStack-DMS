...
var photoRouteSpecs = []routeSpec{
	...
	{pattern: "GET /api/photos/labeling/v1/session", capabilities: authCapPhotosEdit, handler: (*Server).handleLabeling},
	{pattern: "GET /api/photos/labeling/v1/candidates", capabilities: authCapPhotosEdit, handler: (*Server).handleLabeling},
	{pattern: "GET /api/photos/labeling/v1/people/{id}", capabilities: authCapPhotosEdit, handler: (*Server).handleLabeling},
	{pattern: "GET /api/photos/labeling/v1/suggestions", capabilities: authCapPhotosEdit, handler: (*Server).handleLabeling},
	{pattern: "POST /api/photos/labeling/v1/people/{id}/actions", capabilities: authCapPhotosEdit, handler: (*Server).handleLabeling},
	{pattern: "GET /api/photos/labeling/v1/actions/{operation}", capabilities: authCapPhotosEdit, handler: (*Server).handleLabeling},
	{pattern: "GET /api/photos/labeling/v1/faces/{id}/thumbnail", capabilities: authCapPhotosEdit, handler: (*Server).handleLabeling},
	{pattern: "GET /api/photos/labeling/v1/faces/{id}/original", capabilities: authCapPhotosEdit, handler: (*Server).handleLabeling},
