...
var photoRouteSpecs = []routeSpec{
	...
	{pattern: "POST /photos/faces/unignore", capabilities: authCapPhotosEdit, handler: (*Server).handleUnignorePhotoFaces},
	{pattern: "POST /photos/faces/reset-ignored-directory", capabilities: authCapPhotosEdit, handler: (*Server).handleResetIgnoredDirectoryFaces},
	...
	{pattern: "GET /api/photos/v1/faces/{id}/thumbnail", capabilities: authCapPhotosRead, handler: (*Server).handleFaceThumbnail},
	...
	{pattern: "GET /api/photos/labeling/v1/groups", capabilities: authCapPhotosEdit, handler: (*Server).handleLabelMergeGroups},
	{pattern: "GET /api/photos/labeling/v1/people/{id}/folders", capabilities: authCapPhotosEdit, handler: (*Server).handleLabelPersonFolders},
	...
	{pattern: "GET /photos/people/{id}/folder", capabilities: authCapPhotosRead, handler: (*Server).handlePersonFolder},
	{pattern: "POST /photos/people/{id}/folder", capabilities: authCapPhotosEdit, handler: (*Server).handlePersonFolder},
	...
	{pattern: "GET /photos/people/{id}/details", capabilities: authCapPhotosRead, handler: (*Server).handlePersonDetails},
	{pattern: "PUT /photos/people/{id}/details", capabilities: authCapPhotosEdit, handler: (*Server).handlePersonDetails},
	...
	{pattern: "POST /photos/image-groups", capabilities: authCapPhotosEdit, handler: (*Server).handleCreateImageGroup},
	{pattern: "GET /photos/image-groups/{id}", capabilities: authCapPhotosRead, handler: (*Server).handleImageGroup},
	{pattern: "POST /photos/image-groups/{id}", capabilities: authCapPhotosEdit, handler: (*Server).handleImageGroup},
