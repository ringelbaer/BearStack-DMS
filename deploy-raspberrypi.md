...
BearStack benoetigt laut `go.mod` mindestens Go `1.27.1` oder eine kompatible neuere Version. Fuer den Raspberry Pi 5 mit 64-Bit-Raspberry-Pi-OS oder einem anderen 64-Bit-Linux ist das offizielle Paket `linux-arm64` passend.
