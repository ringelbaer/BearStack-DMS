...
class LoadingLayoutTest {
    ...
    @Test fun stickyActionsSeparateNavigationHelpAndNaming() {
        ...
        try {
            ...
            assertTrue(actions.getUnclippedBoundsInRoot().right <= pencil.getUnclippedBoundsInRoot().left)
            ...
            compose.onNodeWithContentDescription("Zurück zum Benennen").performClick()
            compose.onNodeWithContentDescription("Weitere Optionen").performClick()
