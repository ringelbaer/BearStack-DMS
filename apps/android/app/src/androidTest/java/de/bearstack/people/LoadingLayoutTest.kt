...
class LoadingLayoutTest {
    ...
    @Test fun stickyActionsSeparateNavigationHelpAndNaming() {
        ...
        try {
            ...
            assertTrue(pencil.getUnclippedBoundsInRoot().left < help.getUnclippedBoundsInRoot().left)
            assertTrue(help.getUnclippedBoundsInRoot().left < actions.getUnclippedBoundsInRoot().left)
