...
class LoadingLayoutTest {
    ...
    @Test fun stickyActionsSeparateNavigationHelpAndNaming() {
        ...
        try {
            ...
            assertTrue(actions.getUnclippedBoundsInRoot().right <= help.getUnclippedBoundsInRoot().left)
            assertTrue(help.getUnclippedBoundsInRoot().right <= pencil.getUnclippedBoundsInRoot().left)
