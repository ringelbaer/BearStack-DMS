...
Aktuelle Version: **0.52.2** · Android-App: **0.12.1**.
...
Im Android-Modus **Ähnliche Gruppen** startet der automatische Lupenabgleich nur, wenn **beide Gruppen unbenannt** sind. Ausschließlich das Vergleichsgesicht von **Gruppe 1** liefert gemeinsame **Benennungsvorschläge für beide Gruppen** unter Ignorieren und Stift. Treffer mit Referenzportrait sind bereits während der Suche wählbar; Antippen ordnet **beide Gruppen atomar** derselben Person zu und lädt nach Bestätigung das nächste Paar. Ein gemeinsamer Lade-, Leer- oder Fehlerzustand erlaubt eine gezielte Wiederholung; höchstens eine Suchanfrage und 20 Treffer, keine automatischen Fehlerschleifen. Fertige Ergebnisse bleiben für das aktuelle Paar erhalten; Einzelaktionen verwerfen die gemeinsame Liste. Revisionsprüfungen beider Gruppen und der Zielperson sowie Aktionsquittungen sichern Konflikte und verlorene Antworten ab.
