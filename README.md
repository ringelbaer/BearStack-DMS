...
Aktuelle Version: **0.57.1** · Android-App: **0.14.0**.
...
Unterseiten führen mit **← Alle Personen** zurück zur Übersicht. **Anzeige** und **Hilfe** sind einheitliche Buttons und bleiben beim Öffnen an ihrer Position; der Inhalt erscheint darunter. Bei bereits benannten Personen zeigt der Button zum Benennen / Zuordnen nur das Stiftsymbol; bei unbenannten Gruppen bleibt die Beschriftung sichtbar.
