...
Aktuelle Version: **0.52.4** · Android-App: **0.12.2**.
...
Android, **Ähnliche Gruppen**: Sobald beide Vergleichsgruppen bestätigt ignoriert sind, öffnet sich automatisch die nächste Kombination. Verlorene Antworten werden vorher über die Aktionsquittung geklärt; bei einem Ladefehler lässt sich das nächste Paar ohne erneutes Ignorieren laden.
