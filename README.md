...
Ab App **0.9.0** und BearStack **0.49.0** zeigt **Menü → Ähnliche Gruppen** immer ein Gruppenpaar als einzelne Entscheidung. **Zusammenführen** oder **Getrennt lassen** speichert die Entscheidung und lädt automatisch das nächste Paar; beide Buttons bleiben ohne Scrollen erreichbar. Beide Portraits bieten die Originalfoto-Vergrößerung per Halten und Wischen wie beim Benennen. Beide Portraits stehen gleich groß auf derselben Höhe; Namen und Gesichtsanzahlen sind darunter ausgerichtet. Ignorieren und Stift stehen kompakt unter der jeweiligen unbenannten Gruppe. Bei wenig Platz oder großer Schrift scrollt nur der Vergleichsbereich, während die Entscheidungsbuttons unten sichtbar bleiben. Gruppenrevisionen und dauerhaft gespeicherte Aktionsquittungen sichern Konflikte und Verbindungsabbrüche ab. Die Benennen-Warteschlange bleibt erhalten; der vorhandene begrenzte Originalbildcache wird wiederverwendet.
